...
def algo2GetSlopes(image):
    ...
    file = open("Path2Algorithm2.txt", "w")
    
    #PATH 2
    imageCpy = image.copy()
    cv2.line(imageCpy, (402, 480), (300, 400), color=[255, 0, 0], thickness=2)
    cv2.line(imageCpy, (640, 466), (420, 400), color=[255, 0, 0], thickness=2)
    ...
    cv2.imwrite("Algo2Check.jpg", image1)
    '''
